System.register(['@angular/router', './login/login.component', './signup/signup.component', './main/overview.component', './main/main.component', './todolist/todolist.component', './todolist/addTodolist.component'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var router_1, login_component_1, signup_component_1, overview_component_1, main_component_1, todolist_component_1, addTodolist_component_1;
    ...
    return {
        setters:[
            ...
            function (addTodolist_component_1_1) {
                addTodolist_component_1 = addTodolist_component_1_1;
            }],
        execute: function() {
            /**
            ...
            exports_1("CLIENT_ROUTER_PROVIDERS", CLIENT_ROUTER_PROVIDERS = [
                router_1.provideRouter([
                    ...
                    { path: 'addTodolist', component: addTodolist_component_1.AddTodolistComponent },
